(function () {
    ...
    app.data.connections = [
        ...
        { from: 'content', to: 'project-yc-obsidian', kind: 'secondary' },
        ...
        { from: 'experience-main-label', to: 'project-yc-cast', kind: 'primary' },
        { from: 'experience-main-label', to: 'project-ycapikit', kind: 'primary' },
        { from: 'experience-main-label', to: 'project-yc-obsidian', kind: 'primary' },
        { from: 'experience-main-label', to: 'project-sharememory', kind: 'primary' },
        { from: 'experience-main-label', to: 'project-always', kind: 'primary' },
        { from: 'experience-main-label', to: 'project-resume-tailor', kind: 'primary' },
        { from: 'experience-main-label', to: 'project-open-source', kind: 'primary' },
        { from: 'section-experience', to: 'experience-side-label', kind: 'secondary' },
        { from: 'experience-side-label', to: 'project-lawdesk', kind: 'primary' },
