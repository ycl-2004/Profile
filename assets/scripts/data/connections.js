(function () {
    ...
    app.data.connections = [
        ...
        { from: 'self-ai-tooling', to: 'project-resume-tailor', kind: 'secondary' },
        ...
        { from: 'skills', to: 'project-yc-cast', kind: 'secondary' },
        { from: 'skills', to: 'project-resume-tailor', kind: 'secondary' },
        ...
        { from: 'project-yc-cast', to: 'connect-collab', kind: 'secondary' },
        { from: 'project-resume-tailor', to: 'connect-collab', kind: 'secondary' },
