(function () {
    ...
    app.data.portfolioItems = [
        {
            ...
            impact: 'Shipped 10 merged PRs across BLE connectivity, live data visualization, test tooling, and gray-box control workflows.',
            stack: ['React', 'TypeScript', 'Kotlin', 'Android WebView', 'BLE', 'IP']
        },
        {
            id: 'project-open-source',
            title: 'Open-Source Maintenance',
            subtitle: 'Upstream product and workflow improvements',
            ...
            icon: '↗',
            tone: 'mint',
            description: 'Maintained and extended open-source products while keeping original ownership and fork provenance explicit.',
        ...
        },
        {
            ...
            subtitle: 'Evidence-first legal workflow',
            category: 'Project',
            type: 'AI / RAG',
            layer: 'projects',
            dateLabel: '2026',
            ...
            icon: '⚖',
            tone: 'amber',
            description: 'Browser and FastAPI workspace for evidence-grounded legal research and structured case analysis.',
            impact: 'Combined guardrailed extraction, deterministic calculations, RAG retrieval, and 90+ frontend/backend tests.',
            stack: ['FastAPI', 'Python', 'RAG', 'Testing', 'Guardrails']
        },
        {
    ...
    app.data.timelineMilestones = [
        ...
        },
        {
            ...
            layer: 'projects',
            tone: 'mint',
            items: ['work-delta', 'project-open-source', 'project-yc-cast', 'project-ycapikit', 'project-yc-obsidian', 'project-sharememory', 'project-always', 'project-lawdesk', 'project-resume-tailor', 'project-family-care', 'project-todo']
        },
        {
            period: 'Next',
