(function () {
    ...
    app.templates.cards = `
        <div class="card" style="left:260px;top:90px;width:330px;animation-delay:0.08s;" data-card="profile" data-layer="profile">
        ...
        <div class="card card-timeline" style="left:660px;top:90px;width:420px;animation-delay:0.12s;" data-card="timeline" data-layer="timeline">
        ...
        <div class="card card-sticky sticky-purple" style="left:660px;top:420px;width:260px;animation-delay:0.16s;" data-card="sticky-agent-native" data-layer="sticky-agent">
            <div class="sticky-title">🤖 Agent Native</div>
            <div class="sticky-body">把 AI 当队友：让工作流更快、更可靠、更可重复</div>
        </div>

        <div class="card card-quote" style="left:260px;top:440px;width:370px;animation-delay:0.2s;" data-card="narrative" data-layer="narrative">
        ...
        <div class="card" style="left:660px;top:570px;width:340px;animation-delay:0.24s;" data-card="ai-partner" data-layer="narrative">
        ...
        <div class="card card-skills" style="left:1120px;top:140px;width:520px;animation-delay:0.28s;" data-card="skills" data-layer="skills">
        ...
        <!-- Projects (Primary) -->
        <div class="card card-project" style="left:1120px;top:360px;width:340px;animation-delay:0.32s;" data-card="project-crypto" data-layer="projects">
        ...
        <div class="card card-project" style="left:1480px;top:360px;width:340px;animation-delay:0.34s;" data-card="project-dao" data-layer="projects">
        ...
        <div class="card card-project" style="left:1120px;top:600px;width:340px;animation-delay:0.36s;" data-card="project-todo" data-layer="projects">
        ...
        <div class="card card-project" style="left:1480px;top:600px;width:340px;animation-delay:0.38s;" data-card="project-family-care" data-layer="projects">
        ...
        <div class="card card-project" style="left:1120px;top:840px;width:340px;animation-delay:0.4s;" data-card="project-ycapikit" data-layer="projects">
        ...
        <div class="card card-project" style="left:1480px;top:840px;width:340px;animation-delay:0.42s;" data-card="project-edu-analysis" data-layer="projects">
        ...
        <div class="card card-project" style="left:1120px;top:1080px;width:340px;animation-delay:0.44s;" data-card="project-balance-bot" data-layer="projects">
        ...
        <div class="card card-project" style="left:1480px;top:1080px;width:340px;animation-delay:0.46s;" data-card="project-unity" data-layer="projects">
        ...
        <div class="card card-project" style="left:1120px;top:1320px;width:340px;animation-delay:0.48s;" data-card="project-metal-detector" data-layer="projects">
        ...
        <div class="card card-project" style="left:1480px;top:1320px;width:340px;animation-delay:0.5s;" data-card="project-sailbot" data-layer="projects">
        ...
        <div class="card card-project" style="left:660px;top:820px;width:420px;animation-delay:0.52s;" data-card="work-delta" data-layer="work">
        ...
        <div class="card" style="left:260px;top:820px;width:370px;animation-delay:0.54s;" data-card="content" data-layer="content">
        ...
        <div class="card" style="left:260px;top:1040px;width:370px;animation-delay:0.56s;" data-card="opinion" data-layer="content">
        ...
        <div class="card card-sticky sticky-blue" style="left:660px;top:1040px;width:300px;animation-delay:0.58s;" data-card="motto" data-layer="motto">
        ...
        <div class="card card-sticky sticky-yellow" style="left:660px;top:1200px;width:200px;animation-delay:0.6s;" data-card="sticky-intj" data-layer="sticky-intj">
            <div class="sticky-title">🧠 INTJ</div>
            <div class="sticky-body">安静地建造东西</div>
        </div>

        <div class="card card-sticky sticky-pink" style="left:880px;top:1200px;width:240px;animation-delay:0.62s;" data-card="sticky-agent" data-layer="sticky-agent">
            <div class="sticky-title">🤖 Agent Native</div>
            <div class="sticky-body">用工作流把复杂事变简单</div>
        </div>

        <div class="card" style="left:1120px;top:1520px;width:340px;animation-delay:0.64s;" data-card="education" data-layer="education">
        ...
        <div class="card" style="left:1480px;top:1520px;width:340px;animation-delay:0.66s;" data-card="contact" data-layer="profile">
